...
batch_size  = 4         # Subconjunto de datos
learning_rate = 0.001   # Tasa de aprendisaje
...
#===================================================================================
train_dataset = torchvision.datasets.CIFAR10(root='./Datos/data', train=True,
                                           download=True, transform=transform)

test_dataset = torchvision.datasets.CIFAR10(root='./Datos/data', train=True,
                                           download=True, transform=transform)
...
#==========================================
# Ontener algunas imágenes para entrenar
#==========================================
