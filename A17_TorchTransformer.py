...
class MultiHeadAttention(nn.Module):
    ...
    #======================================
    # Combinar y Trnasponer Subconjuntos
    #======================================
...
class PositionWiseFeedForward(nn.Module):
    #========================================
    # Constructos con Elementos Necesarios
    #========================================
...
class Transformer(nn.Module):
    ...
    def generate_mask(self, src, tgt):
        ...
        nopeak_mask = (1 - torch.triu(torch.ones(1,seq_length),diagonal=1)).bool()
...
if __name__ == "__main__":
    ...
    d_model = 512           # Dimensón de los emdeddings
    num_heads = 8           # Canales de atención
    num_layers = 6          # Capas
    d_ff = 2048             # Dimensión de la res feed-forward
    ...
    for epoch in range(10):
        ...
        optimizer.zero_grad()
        #========================================================
        # Aplicar transfromer a los datos y obtener resultados
        #========================================================
        output = transformer(src_data, tgt_data[:, :-1])
        #===============================================================
        # Cálculo de Error entre las Frases de Salida y Frases Reales
        #===============================================================
