...
import torch
#===================================
# requires_grad = True -> genera 
# funciones gradiente para las 
# operaciones que se hacen con 
# ese tensor
#===================================
x =torch.rand(3, requires_grad=True)
y = x + 2
#===================================
# y = y(x) tiene grad_fn asociado
#===================================
print(x)
print(y)
print(y.grad_fn)
...
print(x.grad)   # dz/dx
#=================================================
# torch.autograd see basa en regla de la cadena
#=================================================
...
print(x.grad)
#====================================================
# Decirle a un tensor que deje generaar gradientes
#====================================================
# - x.requires_grad_(False)
# - x.detach() 
# - envolverlo en 'with torch.no_grad():'
